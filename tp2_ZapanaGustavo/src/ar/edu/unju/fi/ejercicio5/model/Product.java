...
public class Product {
	...
	public Product(String codigo, String descripcion, Double precioUnitario, origenFabricacion origeFabricacion,
			ar.edu.unju.fi.ejercicio5.model.Product.categoria categoria, boolean stock) {
		this.codigo = codigo;
